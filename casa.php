<?php
//Alterado no dia 1/11
//NECESSITA COLOCAR O BLOQUEIO 
  ...
  <div class="w3-main" style="margin-left:200px">
    ...
    <div class="w3-hide-large" style="margin-top:83px">
    	...
    	<div class="w3-row-padding w3-center w3-margin-top">
    		<div class="w3-first">
				<div class="w3-card w3-container" style="min-width:400px">
					<center> 
	...
	<div class="w3-row-padding w3-center w3-margin-top">
		...
		<?php 
			$sistema = $arDB->conferindo($_SESSION['idcasa']);
	...
	<div id="histAtivacao" class="w3-modal">
		...
		<div class="w3-container">
			<center>
			<table class="w3-card w3-table-all w3-centered w3-margin-top w3-margin-bottom">
				<tr>
					...
					<?php
					$historicos = $arDB->histAtivacao($_SESSION['idcasa'],$_SESSION['planoN']);
					//estrutura de repetição tipo whle
						foreach ($historicos as $historico)
						{
							$data       = $historico["hisStatus"];
							$status 		= $historico["condicao"];
							
							echo "<tr class='w3-hover-black'>	
										<th>{$status}</th>
										<th>". date("H:i", strtotime($data))."</th>
										<th>".date("d/m/Y", strtotime($data))."</th>
							      </tr>";	
						}
					?> 					
				</table>	
		...
		<div class="w3-modal-content w3-animate-top w3-card-4">
			...
			<table class="w3-card w3-table-all w3-centered w3-margin-top w3-margin-bottom">
				<tr>
					...
					<th><h2> Ocorrência</h2></th>
					<th> <h2>Hora</h2> </th>
					<th> <h2>Data</h2></th>

				</tr>
				<?php
				$historicosPe = $arDB->histPega($_SESSION['idcasa'],$_SESSION['planoN']);
				//estrutura de repetição tipo whle
					foreach ($historicosPe as $hist)
					{
						$status       = $hist["ocorrencia"];
						$data 		= $hist["disparo"];
